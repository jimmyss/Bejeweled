...
QT_MOC_LITERAL(4, 23, 16) // "on_timer_timeout"

    },
    "Gem\0mouseClicked\0\0Gem*\0on_timer_timeout"
};
...
void Gem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Gem::*)(Gem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Gem::mouseClicked)) {
                *result = 0;
                return;
            }
        }
...
void *Gem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gem.stringdata0))
